...
import com.cirilo.cirilofood.api.v1.assembler.FormPaymentInputDisassembler;
...
import com.cirilo.cirilofood.api.v1.openapi.controller.FormPaymentControllerOpenApi;
...
public class FormPaymentController implements FormPaymentControllerOpenApi {
    ...
    public ResponseEntity<CollectionModel<FormPaymentModel>> list(ServletWebRequest request) {
        ...
        CollectionModel<FormPaymentModel> formsPaymentModel = formPaymentModelAssembler.toCollectionModel(formsPaymment);
