...
import com.cirilo.cirilofood.api.v2.controller.CityControllerV2;
import com.cirilo.cirilofood.api.v2.model.CityModelV2;
import com.cirilo.cirilofood.domain.model.City;

@Component
public class CityModelAssemblerV2 extends RepresentationModelAssemblerSupport<City, CityModelV2> { // class to convert entity to DTO
